...
# قناة الاشتراك الإجباري الثابتة الجديدة
forced_channel = "Al_Rubaie02"
...
@bot_app.on_message(filters.private & ~filters.command("start") & ~filters.command("code"))
